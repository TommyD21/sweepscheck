...
const SITE_META = {
  auditDate:       "2026-08-08",   // Date of this full manual audit
  nextScheduled:   "2026-08-22",   // Next automated check due
  dataVersion:     "3.0.0",
  auditCutoff:     "August 8, 2026",
...
const PLATFORMS = [
  ...
  // ── VGW Holdings ─────────────────────────────────────────────────────────
  {
    ...
    lastVerified:"2026-08-08",
    conf:9.0,
    notes:"Restricted states per official rules v23.0: CA, CT, DE, ID, LA, MI, MS, MT, NV, NJ, NY, TN, WA, WV (updated with OK enacted ban Nov 2026). Age 21+. Min. redemption 100 SC ($100). SC expire 60 days after last login. FL single-play prize cap $5,000. Daily redemption cap $10,000.",
...

  {
    ...
    mailIn:false, mailSC:"5 SC per online request", onlineEntry:true,
    entryMethod:"online_photo",
    mailDetail:"ONLINE SUBMISSION — VGW group online entry process (same as Chumba Casino, confirmed by user). No postal mail required. Steps: (1) Sign into luckylandslots.com. (2) Click 'Entry Request' at the bottom of the platform screen. (3) Complete the Entry Acknowledgment Form. (4) Pass CAPTCHA. (5) Scratch to reveal your unique Entry Request Template wording. (6) Handwrite on a blank 4×6 unlined index card or white paper using black or blue pen, copying the template exactly. (7) Photograph the card clearly within the on-screen frame. (8) Submit selfie if prompted. Each valid request = 5 SC. Note: LuckyLand's static website footer references a legacy postal address (PO Box 5555, Portland ME) — this appears to be outdated/legacy text. The in-platform entry process is confirmed as the online photo system.",
    methods:[
      "Sign-up: 7,777 GC + 10 SC (confirmed May 2026 — one of largest no-deposit SC bonuses tracked)",
      "Daily Bonus: sign in → Get Coins → Daily Bonus → Claim (once per 24 hrs)",
      "Online Entry Request: 5 SC per valid submission",
      "Purchase bonus SC with marked Gold Coin packages",
    ],
    ...
    tosVersion:"Current (verify in-app)",
    lastVerified:"2026-08-08",
    conf:7.5,
    notes:"VGW sister site to Chumba. Slots-only — no poker or table games. Same VGW restricted state list. ~20 progressive jackpots. Exited CA Jan 1 2026 per AB-831. Sign-up bonus confirmed higher than Chumba (10 SC vs 2 SC).",
    risk:"Same VGW enforcement exposure as Chumba. Online entry process collects biometric selfie data. Website footer shows legacy postal address — use the in-platform 'Entry Request' link, not the footer postal address.",
    sources:[
      {type:"operator_tos", label:"LuckyLand Sweeps Rules (login required)", url:"https://luckylandslots.com/sweeps-rules"},
      {type:"operator_doc", label:"LuckyLand T&Cs page", url:"https://www.luckylandslots.com/terms"},
    ],
  },
